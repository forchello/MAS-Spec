...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0/iOS/Release/Yodo1MasMediationBidMachine-4.10.0.zip' }
...
sub.dependency 'Yodo1MasCore', '4.10.0'
sub.dependency 'BidMachine', '2.3.0.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.10.0'
