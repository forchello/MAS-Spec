...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.0/iOS/Release/Yodo1MasMediationIronSource-4.13.0.zip' }
...
sub.dependency 'Yodo1MasCore', '4.13.0'
sub.dependency 'IronSourceSDK', '8.1.0.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationIronSource/Core', '4.13.0'
